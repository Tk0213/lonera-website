...
const BUSINESSES = {
  ...
  // --- trades, added for the multi-service planner ---------------------------
  // These get called together ("plumber, cleaner, electrician"), so each has a
  // Korean-speaking alternative: with one candidate per trade the planner has
  // nothing to choose between.
  hanriver: {
    id: 'hanriver', name: 'Han River Plumbing', category: 'Plumbing',
    icsUrl: process.env.ICS_URL_HANRIVER || null,
    declaredHours: WEEKDAYS_8_6,
  },
  taeyang: { id: 'taeyang', name: 'Taeyang Plumbing and Heating', category: 'Plumbing', declaredHours: WEEKDAYS_8_6 },
  mirae: {
    id: 'mirae', name: 'Mirae Electric', category: 'Electrical',
    icsUrl: process.env.ICS_URL_MIRAE || null,
    declaredHours: WEEKDAYS_8_6,
  },
  voltway: { id: 'voltway', name: 'Voltway Electrical', category: 'Electrical', declaredHours: { 1: [['09:00', '20:00']], 2: [['09:00', '20:00']], 3: [['09:00', '20:00']], 4: [['09:00', '20:00']], 5: [['09:00', '17:00']] } },
  sarang: { id: 'sarang', name: 'Sarang Cleaning', category: 'Cleaning', declaredHours: WEEKDAYS_9_5 },
